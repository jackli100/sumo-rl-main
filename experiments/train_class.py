...
class Train:
    def __init__(self, output_folder, net_file, route_file, total_timesteps, trained_model=None, num_of_episodes=10, seed=10, fix_seed=False, fix_ts=False,\
                 learning_rate=0.0001, learning_starts=0, train_freq=1, target_update_interval=2000, exploration_initial_eps=0.05, exploration_final_eps=0.01, \
                   training_fraction = 0.5 ,verbose=1, tripinfo=False, emissioninfo=False):
        self.output_folder = output_folder
